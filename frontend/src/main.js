...
pluralCaseList.push( {plural: "userProfiles", pascal: "UserProfile"} )

pluralCaseList.push( {plural: "matchingAlgorithms", pascal: "MatchingAlgorithm"} )

pluralCaseList.push( {plural: "matchingResults", pascal: "MatchingResult"} )

pluralCaseList.push( {plural: "chatRooms", pascal: "ChatRoom"} )
pluralCaseList.push( {plural: "chatMessages", pascal: "ChatMessage"} )
